...
public:
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.translate(100, 200).move(45);
    /// \endcode
    ///
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.translate(sf::Vector2f(100, 200)).move(45);
    /// \endcode
    ///
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.move(90).translate(50, 20);
    /// \endcode
    ///
    ...
    /// translate(-center).move(angle).translate(center).
    ///
    /// This function returns a reference to *this, so that calls
    /// can be chained.
    /// \code
    /// sf::Transform transform;
    /// transform.move(90, 8, 3).translate(50, 20);
    /// \endcode
    ///
    /// \param angle Rotation angle, in degrees
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.move(90, sf::Vector2f(8, 3)).translate(sf::Vector2f(50, 20));
    /// \endcode
    ///
    /// \param angle Rotation angle, in degrees
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.scale(2, 1, 8, 3).move(45);
    /// \endcode
    ///
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.scale(sf::Vector2f(2, 1)).move(45);
    /// \endcode
    ///
    ...
    /// \code
    /// sf::Transform transform;
    /// transform.scale(sf::Vector2f(2, 1), sf::Vector2f(8, 3)).move(45);
    /// \endcode
    ///
    /// \param factors Scaling factors
...
/// \ingroup graphics
///
/// A sf::Transform specifies how to translate, move, scale,
